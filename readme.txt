...
Use the latest nightly build from https://nightly.link/nesrak1/UABEA/workflows/dotnet-desktop/master/uabea-windows.zip instead of the latest release from the Releases page
the current latest release (second release) doesn't currently support the version of Unity that CH uses
(be warned that since these are nightly builds, there may be bugs with importing the new atlas)
